<html lang="en"><head>
    ...
    <!-- Bootstrap core CSS -->
<link href="{{URL::asset('admin/docs/dist/css/bootstrap.min.css')}}" rel="stylesheet">
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="#"><b>WOLASI POST</b></a>
      </div>
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic">Media informasi kecamatan Wolasi</h1>
